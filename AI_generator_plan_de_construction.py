...
#1- code pour générer le dataset
...
def generate_house_prompt(nb_ch, nb_sdb, salon, cuisine):
    variations = [
        ...
        f"une maison familiale comprenant {nb_ch} chambres, {nb_sdb} salles de bain, un grand salon de {salon} mètres carrés et une cuisine de {cuisine} m²",
...
"""2-construction du modèle d' IA et entrainnement"""
...
print("✅ Modèle sauvegardé sous cnn_plan_predictor.h5")
...
"""3- génération du plan de construction en basant un prompt entré par un utilisateur"""
...
# =========================
# 1️⃣ Charger le modèle + tokenizer
# =========================
...
# =========================
# 2️⃣ Fonction pour extraire les features depuis un prompt
# =========================
...
# =========================
# 3️⃣ Fonction pour générer le plan et sauvegarder PNG + YAML
# =========================
def draw_and_save_house_plan_ordered(features, filename_prefix="house_plan"):
    ...
    # Chambres alignées horizontalement
    ...
    # Salles de bain alignées en bas
    ...
    ax.set_aspect('equal')
    ax.axis('off')
    plt.title("🏠 Plan de Maison Rectangulaire Généré", fontsize=14, fontweight='bold')

    # Sauvegarde PNG
    png_filename = f"{filename_prefix}.png"
    plt.savefig(png_filename, bbox_inches='tight')
    print(f"✅ Plan sauvegardé en PNG : {png_filename}")
    ...
    print(f"✅ Plan complet sauvegardé en YAML pour le robot : {yaml_filename}")
...
# =========================
prompt = "Maison moderne avec 3 chambres, 2 salles de bain, un pétit salon et une cuisine ouverte."
